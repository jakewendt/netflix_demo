...
#	end
	...
	class Client	
		...
		def consumer
			@consumer ||= begin
				token	 = Netflix.consumer_token
				secret = Netflix.consumer_secret
		...
		def authorize_url(callback_url='http://cnn.com')
...
#	rtoken.authorize_url({ "application_name" => Netflix.application_name, "oauth_consumer_key" => Netflix.consumer_token, 'oauth_callback' => '' })
#
#
#	client.access_token
#
